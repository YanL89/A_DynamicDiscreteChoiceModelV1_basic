...
dynApply = function(M,spec){
  ...
  predCount  
  #in order to compare to the observed market shares
  #in this example, first column should = nobs - sum(last 3 columns) for the calculation of predicted market shares
}
